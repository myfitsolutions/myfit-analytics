(() => {
    ...
    document.addEventListener("DOMContentLoaded",()=>{
        ...
        if(importsAvailable){const integrations=[];const ghlTemplate=document.getElementById("ghl-navigation-item");if(ghlTemplate){const ghlLink=ghlTemplate.content.firstElementChild.cloneNode(true);if(currentNavigationHref()===ghlLink.getAttribute("href"))ghlLink.setAttribute("aria-current","page");integrations.push(ghlLink);}integrations.push(navItem("MyFit Automations","/integrations/myfit-automations","integrations"));nav.append(group("Integrations",integrations));}
